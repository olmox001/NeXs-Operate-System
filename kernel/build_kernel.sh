...
# -I./Subsystems -I./Drivers: Add include paths for headers
...
# Files in Subsystems
C_SOURCES_SUBS="Subsystems/libx.c Subsystems/buddy.c Subsystems/messages.c Subsystems/permissions.c Subsystems/shell.c Subsystems/scheduler.c Subsystems/syscall.c Subsystems/module.c Subsystems/sblock.c Subsystems/idt.c Subsystems/handlers.c"

# Files in Drivers
C_SOURCES_DRIVERS="Drivers/vga.c Drivers/serial.c Drivers/keyboard.c Drivers/timer.c"

# Combined Source List
C_SOURCES="$C_SOURCES_ROOT $C_SOURCES_SUBS $C_SOURCES_DRIVERS"
...
rm -f *.o Subsystems/*.o Drivers/*.o ${KERNEL_ELF} ${KERNEL_BIN} kernel.map
